<header class="mobile-header d-none visible-xs">
  <div class="mobile-header__logo">
    <a href="./">
      <!-- <img src="./../assets/images/logo--light.svg" alt="" > -->
      <svg xmlns="http://www.w3.org/2000/svg" width="100.852" height="176.363" viewBox="0 0 100.852 176.363">
  ...
  <div class="mobile-header__hamburger-menu">
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="22.5" viewBox="0 0 28 22.5" class="pe-none">
  ...
  <div class="mobile-header__menus">
    ...
    <nav class="mobile-header__nav">
      <ul class="mobile-header__nav__menus">
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="./">Home</a>
        </li>
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="about.php">About</a>
        </li> 
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="QDripper.php">Innovation</a>
          <ul class="sub-menu">
        ...
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="coffee.php">Coffee</a>
        </li>
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="coffee-concept.php">Design Concept</a>
        </li>
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="marchandise.php">Merchandise</a>
        </li>
        <li class="mobile-header__nav__menus__list">
          <a class="mobile-header__nav__menus__list--link" href="contact.php">Contact</a>
        </li>
      </ul>
    </nav>
    <div class="mobile-header__social">
      <small class="d-block mb-3 text-transform--uppercase">Stay Connected</small>
      <ul class="mobile-header__social__list">     
        <li style="display: none;">
          <a class="mobile-header__social__list--link" href="#">
        ...
        <li>
          <a class="mobile-header__social__list--link" href="https://www.instagram.com/theqlab.ae/">
